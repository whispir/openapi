...
public class JavaCustomClientCodegenTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
        .setGeneratorName("java-custom") // use this codegen library
        // .setInputSpec("../../../modules/openapi-generator/src/test/resources/2_0/petstore.yaml")
        // // sample OpenAPI file
        .setInputSpec(
            "https://raw.githubusercontent.com/openapitools/openapi-generator/master/modules/openapi-generator/src/test/resources/2_0/petstore.yaml") // or
                                                                                                                                                      // from
                                                                                                                                                      // the
                                                                                                                                                      // server
        .setOutputDir("out/java"); // output directory
