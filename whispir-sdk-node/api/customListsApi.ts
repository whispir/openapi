...
export class CustomListsApi {
    ...
    public async getCustomLists (workspaceId: string, xApiKey: string, accept: 'application/vnd.whispir.customlist-v1+json' | 'application/vnd.whispir.customlist-v1+xml', limit?: number, offset?: number, sortOrder?: 'asc' | 'desc', sortFields?: string, name?: string, type?: 'INCIDENT' | 'MESSAGE' | 'CONTACT' | 'RSS', options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        ...
        if (workspaceId === null || workspaceId === undefined) {
            throw new Error('Required parameter workspaceId was null or undefined when calling getCustomLists.');
        }
     ...
     */
    public async getCustomListsById (workspaceId: string, xApiKey: string, accept: 'application/vnd.whispir.customlist-v1+json' | 'application/vnd.whispir.customlist-v1+xml', customlistId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/workspaces/{workspaceId}/customlists/{customlistId}'
            .replace('{' + 'workspaceId' + '}', encodeURIComponent(String(workspaceId)))
        ...
        // verify required parameter 'workspaceId' is not null or undefined
        if (workspaceId === null || workspaceId === undefined) {
            throw new Error('Required parameter workspaceId was null or undefined when calling getCustomListsById.');
        }
